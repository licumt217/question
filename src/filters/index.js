...
Vue.filter('parseParkingTimeStr', require('./dateFormatter').parseParkingTimeStr)
...
Vue.filter('parseIdentity', require('./stringUtils').parseIdentity)
Vue.filter('parseQuitType', require('./stringUtils').parseQuitType)