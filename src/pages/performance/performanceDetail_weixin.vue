                ...
                <Row type="flex" justify="center" class="formItemRow" align="middle">
                    <Col span="7">
                        <Form-item label="扫码日期:">
                            <Date-picker type="datetime" style="width: 100%" @on-change="handleStartTime"
                                         placeholder="选择日期和时间"></Date-picker>
                        </Form-item>
                    </Col>
                    <Col span="7">
                        <Form-item label="~" :label-width="28">
                            <Date-picker type="datetime" style="width: 100%" @on-change="handleEndTime"
                                         placeholder="选择日期和时间"></Date-picker>
                        </Form-item>
                    </Col>
                ...
                <div class="layout-content-main-bottom">
                    <Row type="flex" justify="center" class="content">
                        <Col span="24">
                            ...
                            <table cellspacing="0" class="addAcount" style="table-layout:auto;"
                                   v-show="qrmPerformList.length>0" cellpadding="0" border="0">
                                <tr>
                                    <td>序号</td>
                                    <td>姓名</td>
                                    <td>手机号</td>
    ...
    mounted: function () {
      ...
      setTimeout(() => {
        if (util.isEmpty(_this.thisPerformId)) {
          util.goto(this, 'performance/performance_weixin')
        }
      ...
      downloadDetail () {
        if (!this.formItem.startDate || !this.formItem.endDate) {
          ...
          window.location = `${location.origin}/tcprom/dtCodeRecord/downloadExcel?qrmDtcodeUserId=${this.thisPerformId}` +
            `&startDate=${this.formItem.startDate}&endDate=${this.formItem.endDate}&excelType=2&createType=1`
        }
      }
    }
  }
