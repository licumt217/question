        ...
        <Card>
            ...
            <Form :model="formItem" :label-width="100">
                ...
                <Row type="flex" justify="space-around" class="formItemRow" align="middle">
                    ...
                    <Col span="5" offset="6" style="text-align:right">
    ...
    export default {
        ...
        methods: {
            ...
            go2detail(perform) {
                ...
                util.goto(this,'performance/performance_weixin/performanceDetail');
            },
            downloadSum() {
                if(!this.formItem.startDate || !this.formItem.endDate){
